...
class ResearchTarget(WorkspaceOwned, table=True):
    ...
    guaranteed_candidate_goal: int = Field(default=0)
    guaranteed_time_seconds: int = Field(default=0)
    consumed_time_seconds: int = Field(default=0)
    reserved_time_seconds: int = Field(default=0)
    shared_lease_count: int = Field(default=0)
